...
# sphinx-quickstart on Sun Mar  6 16:11:15 2016.
#
...
exclude_patterns = ['../../pyfrp/__init__.py','../../pyfrp/subclasses/__init__.py','../../pyfrp/modules/__init__.py','../../pyfrp/gui/__init__.py','../../pyfrp/PyFRAP.py']
...
latex_documents = [
  ('index', 'PyFRAP.tex', u'PyFRAP Documentation',
...
man_pages = [
    ('index', 'pyfrap', u'PyFRAP Documentation',
...
texinfo_documents = [
  ('index', 'PyFRAP', u'PyFRAP Documentation',
   u'Alexander Blaessle', 'PyFRAP', 'PyFRAP: A Python based FRAP analysis tool box.',
   'Miscellaneous'),
]
