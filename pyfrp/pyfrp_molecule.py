...
class molecule:
	...
	def __init__(self,name):
		...
		###NOTE: Will need regions here too!!! Somehow make simplified regions where there is only vectors in there
		#self.tvec_avg=None
		#self.tvec_errors=None
		#self.squ_fitted_av=None
		#self.out_fitted_av=None
		#self.slice_fitted_av=None
		#self.squ_data_av=None
		#self.out_data_av=None
		#self.slice_data_av=None
