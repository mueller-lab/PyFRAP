...
datasets=["A488-dextran-10kDa_agarose_1percent_20140616"]
...
#print Ds, err_Ds, len(Ds), len(err_Ds)
...
plt.draw()
plt.savefig('/home/alex_loc/Documents/Talks/zebrafish2014/figs/bar_fcs.eps')
plt.show()