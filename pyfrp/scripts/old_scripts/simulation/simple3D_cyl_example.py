...
#Run with solve
tvec,squ_abs,out_abs,sl_abs,mphis_abs,squ_conc,out_conc,sl_conc,mphis_conc,mesh=threeD_sim(method='solve',liveplot=False,steps=steps,prof_every=50,norm=False,cellSize=0.1,sweeps=5,dt_scale=dt_scale,debug=debug,addNoise=False,res_req=0.05,final_plot=True,mesh=None)
