...
#Get current zstack
folder="/home/alex_loc/Documents/Research/florencia/zstack"
files=get_sorted_folder_list(folder,".tif")
#files=files[8:]
outfile="zStack2"
outpath=folder+"/"+outfile
...
meshlabscript="/home/alex_loc/Documents/Research/florencia/zstack/normals_"+recon_alg+".mlx"
...
meshlabcmd="meshlabserver -s " + meshlabscript + " -i " + outpath+".ply -o " + outpath + ".stl"
...
f = open(outpath+".geo", 'w')

f.write('Merge "' + outpath + '.stl"; \n')
...
os.system("gmsh -3 " + outpath +".geo -o " + outpath + ".msh")
