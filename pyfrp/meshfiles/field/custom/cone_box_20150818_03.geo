volSize_px=23.0;
center_x=254.348387097;
center_y=249.393548387;
upper_radius=317.65;
lower_radius=224.25;
...
Field[1].VIn = 4.6;
Field[1].VOut = 23.0;
Field[1].XMin = -46.5762090569;
Field[1].XMax = 555.27298325;
Field[1].YMin = -51.5310477666;
Field[1].YMax = 550.318144541;
Field[1].ZMin = -80.2862087694;
Field[1].ZMax = -68.0278767593;
