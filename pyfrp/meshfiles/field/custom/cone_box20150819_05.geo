...
Field[1].VIn = 4.6;
Field[1].VOut = 23.0;
Field[1].XMin = -45.619586282;
Field[1].XMax = 564.226037895;
Field[1].YMin = -57.1808766046;
Field[1].YMax = 552.664747572;
Field[1].ZMin = -84.153146255;
Field[1].ZMax = -71.8948142449;
