...
Field[1].VIn = 6.0;
Field[1].VOut = 30.0;
Field[1].XMin = -38.103867936;
Field[1].XMax = 550.103867936;
Field[1].YMin = -38.103867936;
Field[1].YMax = 550.103867936;
Field[1].ZMin = -42.2624781665;
Field[1].ZMax = -30.0041461564;
