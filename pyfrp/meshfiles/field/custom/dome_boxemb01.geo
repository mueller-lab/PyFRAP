...
//
Field[1] = Box;
Field[1].VIn = 11.6666666667;
Field[1].VOut = 35.0;
Field[1].XMin = 9.387929451;
Field[1].XMax = 510.575871453;
Field[1].YMin = -4.729717607;
Field[1].YMax = 496.458224395;
Field[1].ZMin = -80.5208785754;
Field[1].ZMax = -46.5499162375;
